...
//  pointToPoint.SetDeviceAttribute ("Mtu", UintegerValue (1500));
  ...
  wifiPhy.Set ("RxGain", DoubleValue(8)); 
...
//                             "Direction", StringValue("ns3::UnSiformRandomVariable[Min=0.0|Max=6.283184]"),
//                             "Bounds", RectangleValue (Rectangle (-25, 30, -25, 30)));
 ...
 mobility.Install (wifiStaNodes);
  ...
  for (uint32_t i = 0;i < wifiStaNodes.GetN(); i++){
    ...
    server.SetAttribute("MaxBytes", UintegerValue (25750000000));
...
//  serverApp.Stop(Seconds (20));
 ...
 anim.SetConstantPosition(p2pNodes.Get(1), 5.0, 5.0);
